...
В изначальной версии проекта, был написан некий гибрид jit-транслятора и бинарного компилятора. В нашем мире такая технология не имеет практического применения, поэтому проект исправлен, а именно: сгенерированный бинарный код записывается не просто в буфер, а исполняемый файл - ELF. 
